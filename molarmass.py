...
# Made by Thijmen Voskuilen (thijmen@thijmer.nl). You can edit, distribute or do anything else you want to do with this file, as long as you leave my credits in it. I would also like to know what you have added if you edit the file, but that isn't necessary.
